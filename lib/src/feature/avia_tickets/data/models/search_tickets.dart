...
TicketsSearchQuery ticketsSearchQueryFromJson(String str) =>
    TicketsSearchQuery.fromJson(json.decode(str));
...
class TicketsSearchQuery {
  ...
  factory TicketsSearchQuery.fromJson(Map<String, dynamic> json) =>
      TicketsSearchQuery(
        marker: json["marker"],
        host: json["host"],
        userIp: json["user_ip"],
